import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useModal } from "@/components/modals/Modal";
...
const DownloadPlaylistModal = ({ isDownloadOpen, closeDownload, handleDownloadMissing, redownloadAll, setRedownloadAll } : DownloadPlaylistModalProps ) => {
