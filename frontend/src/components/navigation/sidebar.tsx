...
export default function Sidebar() {
  ...
  return (
    <div className="bg-gray-900 text-white shadow-lg transition-all duration-300">
      {/* Desktop Layout */}
      <div className={`hidden md:flex md:flex-col md:min-h-screen bg-gray-900 text-white shadow-lg transition-all duration-300 ${`${collapsed ? "md:w-20" : "md:w-50"} flex flex-col p-4`}`}>
