...
const VideoStatus = ({ video, progress, download_stage, onDownload, download_status, error, isLoading}: VideoStatusProps) => {
    ...
    return isDownloaded ? (
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-blue-400 text-blue-300 bg-blue-900/20">
              ...
              <span className="text-sm">{download_stage ?? ""} {progress ?? 0}%</span>
            </div>
          ) : (
            <button
